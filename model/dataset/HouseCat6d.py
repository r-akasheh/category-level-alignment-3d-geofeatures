...
from model.lib.utils import read_ply, to_tsfm, to_o3d_pcd, to_tensor, get_correspondences
from model.lib.benchmark_util import load_log
...
class HouseCat6dDataset(Dataset):
    def __init__(self, config, split, data_augmentation=True):
        super(HouseCat6dDataset, self).__init__()
...
class HouseCat6dTestset(Dataset):
    def __init__(self, config, split, data_augmentation):
        super(HouseCat6dTestset, self).__init__()
